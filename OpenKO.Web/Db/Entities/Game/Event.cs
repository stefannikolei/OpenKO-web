...
public partial class Event
{
    ...
    [StringLength(128)]
    [Unicode(false)]
    public string Exec1 { get; set; } = null!;

    [StringLength(128)]
    [Unicode(false)]
    public string Exec2 { get; set; } = null!;

    [StringLength(128)]
    [Unicode(false)]
    public string Exec3 { get; set; } = null!;

    [StringLength(128)]
    [Unicode(false)]
    public string Exec4 { get; set; } = null!;

    [StringLength(128)]
    [Unicode(false)]
    public string Exec5 { get; set; } = null!;
}
